            ...
            >
                <div className="w-[95%] 800px:w-[92%] m-auto py-2 h-full">
                    <div className="w-full h-[80px] flex items-center justify-between p-3">
                        <div>
                            {/* <Link href={"/"}> <h1 className="font-bold text-sm sm:text-xl flex flex-wrap">
                            ...
                            <Link
                                href={"/"}
                                className={`text-[25px] font-Poppins font-[500] text-black dark:text-white flex flex-wrap`}>
